...
export const lessons = pgTable("lessons", {
  ...
  hlsUrl: text("hls_url"),
  hlsStatus: varchar("hls_status", { length: 20 }).default("none"),
...
export const udyogInternships = pgTable("udyog_internships", {
  ...
  description: text("description").notNull(),
  shortDescription: varchar("short_description", { length: 500 }),
  skillLevel: varchar("skill_level", { length: 30 }).notNull().default("beginner"),
  ...
  finalIntegration: text("final_integration"),
  testing: text("testing"),
  deployment: text("deployment"),
  liveProjectOutput: text("live_project_output"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
});
