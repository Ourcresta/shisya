...
-- Run this SQL on Admin/Shared PostgreSQL database
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_shishya_usha_conversations_user ON shishya_usha_conversations(user_id);

-- View for published courses (SHISHYA reads only published)
CREATE OR REPLACE VIEW published_courses_view AS
SELECT * FROM courses
WHERE status = 'published' AND is_active = true;

-- Comments
COMMENT ON TABLE shishya_users IS 'SHISHYA student portal - user accounts';
COMMENT ON TABLE shishya_sessions IS 'SHISHYA student portal - session storage';
COMMENT ON TABLE shishya_user_profiles IS 'SHISHYA student portal - user profiles';
COMMENT ON TABLE shishya_course_enrollments IS 'SHISHYA student portal - course enrollments';
COMMENT ON TABLE shishya_user_credits IS 'SHISHYA student portal - learning credits';
COMMENT ON TABLE shishya_usha_conversations IS 'SHISHYA student portal - Usha AI tutor conversations';

-- ============================================================
-- Total: 29 SHISHYA tables created
-- ============================================================
