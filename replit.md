...
- **Usha AI Tutor:** Context-aware AI assistant integrated into lesson, lab, and project pages. Uses OpenAI's gpt-4.1-mini model with strict guardrails to never give direct answers - only explanations, hints, and guidance. Rate-limited to 10 requests/minute per student. Backend endpoint at POST /api/usha/ask. Appears as floating avatar button in bottom-right corner. Conversation history stored in PostgreSQL.
